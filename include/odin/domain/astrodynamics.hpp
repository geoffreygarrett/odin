...
template<typename Float>
std::vector<Float> anomaly_mean_to_true(std::vector<Float> MM, std::vector<Float> ee, int max_iter = 1000, Float tolerance = 1e-6) {
    // Convert from mean anomaly to eccentric anomaly
...
template<typename Float>// TODO: Check this
...
template<typename Float>
constexpr std::tuple<Eigen::Vector3<Float>, Eigen::Vector3<Float>> coe2pqr(
        Float p,
        Float e,
        Float nu,
        Float mu) {
...
template<typename Float>
constexpr std::tuple<Eigen::Vector3<Float>, Eigen::Vector3<Float>> coe2rv(
...
template<typename Float>
constexpr std::tuple<Eigen::Matrix<Float, 3, Eigen::Dynamic>, Eigen::Matrix<Float, 3, Eigen::Dynamic>> coe2rv(
