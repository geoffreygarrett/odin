...
namespace odin {
    ...
    public:
        ...
        static_assert(
                ((GSL_PREC_MODE == GSL_PREC_DOUBLE)
                 || (GSL_PREC_MODE == GSL_PREC_SINGLE)
        ...
        [[nodiscard]] Eigen::Vector3<Scalar> acceleration_impl(const Eigen::Vector3<Scalar> &position) const {
            Scalar kappa_0 = compute_confocal_ellipsoid_root(
