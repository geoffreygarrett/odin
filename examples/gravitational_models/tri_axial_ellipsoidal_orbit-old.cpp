...
int main() {
    ...
    const Scalar                                 t_end   = 1000000.0;
    const Scalar                                 dt      = 50.0;
    ...
    for (int i = 0; i < steps; ++i) {
        ...
        const double sma   = 450.0 + 10.0 * i / 10.0;
        const double e     = 0.0;
        ...
        auto [position, velocity] = coe2rv(p, a, e, i * DEG_TO_RAD, Omega * DEG_TO_RAD, omega * DEG_TO_RAD, nu * DEG_TO_RAD, mu);
